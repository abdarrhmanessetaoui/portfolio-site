...
كما اشتغلت على أطر وأدوات حديثة مثل Laravel، React، Node.js و Git.`,
      ...
      "webDev": "تطوير الويب",
      "webDevDesc": "كنطوّر مواقع وتطبيقات ويب عصرية ومتجاوبة باستعمال JavaScript، PHP، Laravel، React وNode.js. كنركز على كود نقي، تصميم بسيط وتجربة مستخدم ممتازة.",
      "cybersecurity": "أساسيات الأمن السيبراني",
      "cybersecurityDesc": "عندي معرفة بأساسيات الحماية الإلكترونية باش نعاون نحمي المواقع والتطبيقات من التهديدات الشائعة ونأمن بيانات المستخدمين.",
      "network": "مفاهيم الشبكات",
      "networkDesc": "كنفهم المبادئ الأساسية ديال الشبكات، وهذا كيعونني نحسن الأداء ديال الويب ونتصرف مزيان فالمشاكل ديال الاتصال."
