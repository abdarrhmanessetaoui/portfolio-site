...
كما اشتغلت على أطر وأدوات حديثة مثل Laravel، React، Node.js و Git.`,
      ...
      "portfolioDesc": "قمت ببناء هذا الموقع الشخصي من الصفر باستخدام HTML وCSS وJavaScript. يسلط الضوء على مهاراتي، ويعرض بعض مشاريعي، ويقدم لمحة واضحة عن خلفيتي المهنية. التصميم نظيف ومتجاوب وسهل التصفح عبر جميع الأجهزة.",
      "codeProject": "عرض كود المصدر",
      "reviewProject": "عرض تجريبي مباشر",
      "portfolioImgAlt": "لقطة شاشة لمشروع السيرة الذاتية",
      "sou9naTitle": "سوقنا - الفواكه والخضروات",
      "sou9naDesc": "متجر إلكتروني مغربي حديث ومتجاوب متخصص في بيع الفواكه والخضروات. يتميز التصميم بالنظافة والتوافق مع الأجهزة المحمولة، مع إبراز العروض الموسمية. يوفر تجربة مستخدم سلسة بأجواء السوق المحلية مع أدوات إدارية مؤقتة.",
      "sou9naImgAlt": "معاينة لموقع سوقنا للفواكه والخضروات",
      "inDev": "قيد التطوير...",
    }
  };
