...
كما اشتغلت على أطر وأدوات حديثة مثل Laravel، React، Node.js و Git.`,
      ...
      "portfolioDesc": "بنيت هاد البورتفوليو الشخصي من الصفر باستخدام HTML، CSS وJavaScript. كيبرز المهارات ديالي، وكيوضح بعض المشاريع، وكيعطي نظرة واضحة على المسار ديالي. التصميم نظيف، متجاوب، وسهل التصفح على جميع الأجهزة.",
      ...
      "sou9naDesc": "متجر إلكتروني مغربي حديث ومتجاوب مخصص للفواكه والخضر. التصميم نظيف ومتوافق مع الهواتف، وكيبرز العروض الموسمية. فيه جو السوق المحلي مع تنقل سهل وضوابط إدارية تجريبية.",
