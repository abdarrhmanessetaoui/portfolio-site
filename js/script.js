...
كما اشتغلت على أطر وأدوات حديثة مثل Laravel، React، Node.js و Git.`,
      ...
      "portfolioDesc": "بنيت هاد البورتفوليو الشخصي من الصفر باستخدام HTML، CSS وJavaScript. كيبين المهارات ديالي، كيعرض بعض المشاريع ديالي، وكيعطي نظرة واضحة على المسار ديالي. التصميم نظيف، متجاوب، وسهل التصفح على أي جهاز.",
      "codeProject": "شوف الكود المصدر",
      "reviewProject": "تجربة مباشرة",
      "portfolioImgAlt": "صورة لمشروع البورتفوليو",
      "sou9naTitle": "سوقنا - الفواكه والخضر",
      "sou9naDesc": "متجر إلكتروني مغربي جديد ومتجاوب مخصص للفواكه والخضر. التصميم نظيف ومتوافق مع الهواتف، وكيبرز العروض الموسمية. فيه جو السوق المحلي مع تنقل سهل وضوابط إدارية تجريبية.",
      "sou9naImgAlt": "معاينة لموقع سوقنا للفواكه والخضر",
      "inDev": "قيد التطوير..",
    }
  };
