document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    en: {
      ...
      //projects
      "projectsHeadline": "<span>Projects</span> ",
    ...
    fr: {
      ...
      //projects
      "projectsHeadline": "<span>Projets</span>",
      ...
      githubUserFinderTitle: "Chercheur d'utilisateurs GitHub",
      githubUserFinderDesc: "Une application web simple pour rechercher des utilisateurs GitHub et afficher leurs informations de profil et dépôts. Comprend l’avatar, la bio, les abonnés, les meilleurs dépôts, et un design réactif et épuré.",
      githubUserFinderImgAlt: "Aperçu de l'application GitHub User Finder",  
...
كما اشتغلت على أطر وأدوات حديثة مثل Laravel، React، Node.js و Git.`,
      ...
      deutsch: "الألمانية",
      //services
      "servicesHeadline": "<span>الخدمات</span>",
      "webDev": "تطوير الويب",
      ...
      githubUserFinderTitle: "الباحث عن مستخدمي GitHub",
      githubUserFinderDesc: "تطبيق ويب بسيط للبحث عن مستخدمي GitHub وعرض معلومات ملفاتهم الشخصية والمستودعات. يتضمن الصورة، النبذة، المتابعين، أفضل المستودعات، وتصميم نظيف ومتجاوب.",
      githubUserFinderImgAlt: "معاينة تطبيق الباحث عن مستخدمي GitHub",  
